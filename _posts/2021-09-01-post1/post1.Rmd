...
Here an interactive table has been provided for your own data exploration, feel free to play around the dataset and use it as a complement to the following analysis in this post. 
```{r interactive_table}
